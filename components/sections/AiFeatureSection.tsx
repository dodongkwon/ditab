...
const aiFeatures: IAiFeature[] = [
  ...
  {
    title: '영상처리 기반 분석 지원',
    description: '행동인식 기반 기술로 주차, 보안안, 사고 등 환경에 대한 사용자 지정 이벤트 자동 분류와 매장의 상품, 소비자 패턴과 매출을 분석하여 마케팅 전략을 제시합니다.',
    features: [
      '원하는 유형에 대한 이벤트 자동분류',
  ...
  },
  {
    ...
    description: '중대재해와 화관법, 화평법 등 취급화학물질에 대한 산업안전을 지켜줄\n LLM 기반 전문 컨설턴트와 함께 관리할 수 있습니다.',
    features: [
      '모든 화학 관련 법령 능동형 검색',
      'LLM 기반의 자율 질의 및 컨설팅 기능',
